...
class TareaListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['suma_porcentaje']=Tarea.objects.filter(tarea_unidad=self.kwargs.get('id_unidad')).aggregate(Sum('tarea_porcentaje'))
        return context
    ...
    def get_queryset(self):
        ...
        'tareaDocumento_pertenece__last_name',
            ...
            total_suma=Sum('tareaDocumento_calificacion')
                ...
                suma_real_porcentaje = Sum((F('tareaDocumento_Tarea__tarea_porcentaje')/10)*F('tareaDocumento_calificacion'), output_field=FloatField()),
                promedio_materia =     Sum((F('tareaDocumento_Tarea__tarea_porcentaje')/10)*F('tareaDocumento_calificacion'), output_field=FloatField())/10,
            ).order_by('tareaDocumento_pertenece')
